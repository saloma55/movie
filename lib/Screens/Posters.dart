          ...
          return Builder(
            builder: (BuildContext context) {
              return GestureDetector(
                onTap: (){
                  Navigator.pushNamed(context, ViewDetails.routeName,arguments:popularpost[i].id );
                },
                child: Container(
                      ...
                      children: [
                       Column(
                         crossAxisAlignment: CrossAxisAlignment.stretch,
                          children: [
                            Expanded(
                              child: Image.network("https://image.tmdb.org/t/p/w200${popularpost[i].posterPath}"??"",
                            ...
                            Container(
                              ...
                              child: Text(popularpost[i].title??'',
                            ...
                            Container(
                              ...
                              child: Text(popularpost[i].releaseDate?.substring(0,10)??'',
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    color: Colors.grey
                                ),),
